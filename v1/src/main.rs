...
use bevy::prelude::{
    Camera2dBundle, Color, Commands, Component, KeyCode, Mut, Projection, Query, Res, ResMut,
    Resource, Sprite, TextBundle, Time, Transform,
};
...
fn main() {
    App::new().add_plugins((DefaultPlugins, NebulaVault)).run();
}
